VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rpttest_result 
   Bindings        =   "rpttest_result.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ...
   TopMargin       =   1440
   BottomMargin    =   1440
   DataMember      =   "testresult_Grouping"
   NumSections     =   7
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "rpttest_result"
